...
/*   Updated: 2026/08/20 22:49:46 by gustde-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_push_swap.h"

static int	validate_numeric_array(int argc, char **argv,
		long **array, int *size)
{
	int	i;
...
static int	init_env(int argc, char **argv, t_config *config,
		t_list **stack_a)
{
	char	**nums;
	int		num_count;
...
static void	execute_sort(t_config *config, t_list **a,
		t_list **b, t_count *op)
{
